...
router.put("/admin/about", async (req, res): Promise<void> => {
  ...
  const values = {
    ...
    companyDescKo: v.companyDescKo,
    companyDescEn: v.companyDescEn,
    companyDescJa: v.companyDescJa,
    companyDescZh: v.companyDescZh,
    companyDescVi: v.companyDescVi,
    philosophyImageUrl: v.philosophyImageUrl ?? null,
    philosophyHeadingKo: v.philosophyHeadingKo,
    philosophyHeadingEn: v.philosophyHeadingEn,
    philosophyHeadingJa: v.philosophyHeadingJa,
    philosophyHeadingZh: v.philosophyHeadingZh,
    philosophyHeadingVi: v.philosophyHeadingVi,
    philosophyIntroKo: v.philosophyIntroKo,
    philosophyIntroEn: v.philosophyIntroEn,
    philosophyIntroJa: v.philosophyIntroJa,
    philosophyIntroZh: v.philosophyIntroZh,
    philosophyIntroVi: v.philosophyIntroVi,
    philosophyCards: v.philosophyCards,
    founderHeadingKo: v.founderHeadingKo,
    founderHeadingEn: v.founderHeadingEn,
    founderHeadingJa: v.founderHeadingJa,
    founderHeadingZh: v.founderHeadingZh,
    founderHeadingVi: v.founderHeadingVi,
    founderIntroKo: v.founderIntroKo,
    founderIntroEn: v.founderIntroEn,
    founderIntroJa: v.founderIntroJa,
    founderIntroZh: v.founderIntroZh,
    founderIntroVi: v.founderIntroVi,
    founderOutroKo: v.founderOutroKo,
    founderOutroEn: v.founderOutroEn,
    founderOutroJa: v.founderOutroJa,
    founderOutroZh: v.founderOutroZh,
    founderOutroVi: v.founderOutroVi,
    founderAreas: v.founderAreas,
    whyDostacItems: v.whyDostacItems.map((item) => ({
      ...item,
